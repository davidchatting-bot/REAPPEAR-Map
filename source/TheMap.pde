...
String piholeserver = System.getenv("PIHOLE_SERVER");
String piHoleKey = System.getenv("PIHOLE_KEY");
String ipinfoToken = System.getenv("IPINFO_TOKEN");
...
void animateTo(float lon, float lat, float speedSec) {
  if(!isAnimating) {
    ...
    aniX = new Ani(this, speedSec, "angleX", radians(-lon), easing);
